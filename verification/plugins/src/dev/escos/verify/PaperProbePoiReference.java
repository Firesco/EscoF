 ...
 */
public final class PaperProbePoiReference {
    ...
    public static void findClosestPoiDataRecords(final PoiManager poiStorage,
        ...
        // Leaf start - Optimize PaperProbePoiReference visited section tracking
        ...
        // Leaf end - Optimize PaperProbePoiReference visited section tracking
        ...
        while (!queue.isEmpty()) {
            ...
            /* 这个 不需要了 (指bound check) // Leaf - Optimize PaperProbePoiReference visited section tracking
            if (sectionX < lowerX || sectionX > upperX || sectionY < lowerY || sectionY > upperY || sectionZ < lowerZ || sectionZ > upperZ) {
                // out of bound chunk
                continue;
            }*/ // Leaf - Optimize PaperProbePoiReference visited section tracking
    ...
    private PaperProbePoiReference() {
